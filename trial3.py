...
with open('binary_pipeline.pickle', 'rb') as f: # Open the file in binary read mode
    binary_classifier = pickle.load(f)  # Load binary classification model
with open('stage_pipeline.pickle', 'rb') as f: # Open the file in binary read mode
    stage_classifier = pickle.load(f)
